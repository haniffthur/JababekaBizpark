            ...
            <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                                ...
                                <td>
                                    @if ($bill->status == 'unpaid')
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                            data-target="#payModal" data-id="{{ $bill->id }}" data-period="{{ $bill->period }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center">Belum ada tagihan IPL.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div class="modal fade" id="payModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                {{-- ADDED: enctype="multipart/form-data" is crucial for file uploads --}}
                <form action="" method="POST" enctype="multipart/form-data" id="payForm">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- NEW: File Input for Proof of Payment --}}
